/*package com.aetherwork.example.jersey2.api;
...
import com.aetherwork.example.jersey2.SetApplication;
import com.aetherwork.example.jersey2.SetCallHandler;
...
public class SetApiTests extends JerseyTest {
	...
	*//**
	...
	public void addMultipleSingleCall() throws InvalidRequestException {
		final Set<String> valuesToStore = new HashSet<>(Arrays.asList("a", "n", "g", "u", "s", "m", "a", "c"));
	...
	*//**
	...
	public void getCallSingleValue() {
		final Set<String> valuesToStore = new HashSet<>();
